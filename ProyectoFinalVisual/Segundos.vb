...
Public Class Segundos
    ...
    Private Sub Segundos_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.ControlBox = False
        Dim cnn As New MySqlConnection(cadenaconexion)
        sql = "SELECT IdProducto,Nombre,Precio,Descripcion  FROM productos WHERE Orden like '" & 2 & "'"
